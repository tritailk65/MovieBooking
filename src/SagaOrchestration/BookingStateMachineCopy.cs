...
public sealed class BookingStateMachineCopy : MassTransitStateMachine<BookingSaga>
{
    private readonly ILogger<BookingStateMachineCopy> _logger;
    ...
    public BookingStateMachineCopy(ILogger<BookingStateMachineCopy> logger)
    {
        ...
        During(ResolvingUnknownPayment,
            ...
            When(LatePaymentSucceded)   // Payment result đến trễ
                .Then(LogSagaState)
                .Publish(CreateRefundPaymentCommand)
                .TransitionTo(Compensating)
        );
