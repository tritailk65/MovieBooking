...
[TestFixture]
public class BookingSagaStateMachineCopySpec
{
    private ServiceProvider _provider = null!;
    private ITestHarness _harness = null!;
    private QuartzTimeAdjustment _adjustment;
    private ISagaStateMachineTestHarness<BookingStateMachineCopy, BookingSaga> _sagaHarness = null!;
    ...
    public async Task Setup()
    {
        _provider = new ServiceCollection()
            ...
            {
                x.AddSagaStateMachine<BookingStateMachineCopy, BookingSaga>();
            })
            .BuildServiceProvider(true);

        _harness = _provider.GetTestHarness();
        await _harness.Start();
        _sagaHarness = _harness.GetSagaStateMachineHarness<BookingStateMachineCopy, BookingSaga>();
    ...
    public async Task BookingCancellationRequest_WhenPendingPayment_ShouldCancelBookingAndReleaseSeat()
    {
        ...
        await _harness.Bus.Publish(new BookingCancellationRequestedIntegrationEvent(sagaContext.ReservationId, sagaContext.BookingId));
